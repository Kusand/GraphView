...
/**
 * LineGraphViewDemo creates some dummy data to demonstrate the GraphView component.
 *
 ...
 */
public class StyledLineGraphViewDemo extends Activity {
	/**
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.styled_line_graph);
		LineGraphView graphView = (LineGraphView) findViewById(R.id.sample_line_graph);
        graphView.setTitle("LineGraphViewDemo");
